...
\lstinputlisting[language=Python,firstline=146,lastline=157]{../Code/Simulator/QuSim.py}
...
\lstinputlisting[language=Python,firstline=16,lastline=20]{../Code/Simulator/QuSim.py}
Although some of the gates are coded in using functions from Numpy, for example the identity gate:
\lstinputlisting[language=Python,firstline=36,lastline=37]{../Code/Simulator/QuSim.py}
The 'Dagger' Gates:
\lstinputlisting[language=Python,firstline=38,lastline=55]{../Code/Simulator/QuSim.py}
